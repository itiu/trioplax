...
~/dmd2-053/linux/bin32/dmd -version=dmd2_053 -version=D2 -Iimport/libmongod import/libmongod/setjmp1.di $t_src/Logger.d $t_src/triple.d $t_src/TripleStorage.d \
$t_src/memory/*.d \
src/rt/util/hash.d \
