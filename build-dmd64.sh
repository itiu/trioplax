...
$DMD -m64 -d -Iimport $t_src/Logger.d $t_src/triple.d $t_src/TripleStorage.d \
$t_src/memory/*.d \
src/rt/util/hash.d \
src/tango/text/convert/Integer.d src/tango/core/Exception.d \
$t_src/mongodb/TripleStorageMongoDB.d myversion.d -O -Hdexport/trioplax -release -lib -oftrioplax64
